...
const todoData: TodoCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: '코드 스니펫 저장소', description: '자주 사용하는 코드 스니펫을 저장하고 쉽게 검색하여 복사할 수 있는 개인용 저장소입니다.', implemented: true, path: '/snippet-repository' },
      { name: '이미지 압축/변환기', description: '이미지를 압축하여 파일 크기를 줄이거나, PNG, JPG, WebP 등 다른 형식으로 변환하는 도구입니다.', implemented: true, path: '/image-converter' },
    ],
  },
  {
